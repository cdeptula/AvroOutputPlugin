...
public class AvroOutputField implements Cloneable, Comparable<AvroOutputField> {
  ...
  /**
   * Get the name of the field in the Avro Schema
   * If the Avro field name is null returns the stream field name
   * @return avroName
   */
   ...
   */
  public static String[] getAvroTypeArray()
  {
    return avroDescriptions;
  }
  ...
  public boolean validate() throws KettleException
  {
    ...
    {
      throw new KettleException( "Validation error: Invalid Avro data type "+avroType );
    }
